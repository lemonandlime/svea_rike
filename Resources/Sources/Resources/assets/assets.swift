...
public enum Asset {
  public enum Image {
    public enum HistoryCard {
      ...
      public static let carGustavArmfeldt = ImageAsset(name: "history_card/car_gustav_armfeldt")
      public static let carlMichaelBellman = ImageAsset(name: "history_card/carl_michael_bellman")
      ...
      public static let emmanuelSwedenborg = ImageAsset(name: "history_card/emmanuel_swedenborg")
      ...
      public static let forbindelserMedHansan = ImageAsset(name: "history_card/forbindelser_med_hansan")
      public static let georgCarlVonDobeln = ImageAsset(name: "history_card/georg_carl_von_dobeln")
      ...
      public static let johanHenrikKjellgren = ImageAsset(name: "history_card/johan_henrik_kjellgren")
      public static let johannesBureus = ImageAsset(name: "history_card/johannes_bureus")
      public static let jonsJacobBerzelius = ImageAsset(name: "history_card/jons_jacob_berzelius")
      ...
      public static let katarinaJagellonica = ImageAsset(name: "history_card/katarina_jagellonica")
      public static let kungligaSlottet = ImageAsset(name: "history_card/kungliga_slottet")
      public static let lennartTorstensson = ImageAsset(name: "history_card/lennart_torstensson")
      ...
      public static let ostindiskaKompaniet = ImageAsset(name: "history_card/ostindiska_kompaniet")
